...
**172 achievements · 1220 points · 84 missable · 1 ongoing**

### Missable Achievements ⚠️

Sorted by cutoff — complete these before the listed section or they become unavailable.
...
- [ ] 🥉 **Corresponding Crystal Crushers** — During four guardian crystals battle, each crystal must only be damaged by the character whose role matches its element [Bartz=Wind, Lenna=Water, Faris=Fire, Galuf=Earth] (5 pts) ⚠️ Missable
- [ ] 🥉 **True Warriors** — Obtain every crystal shard (5 pts)

#### 4.1.3 Prelude; Faris Scherwiz

- [ ] 🥉 **Beautiful Buccaneer** — Galuf and Bartz swoon at the pirate's beauty. (1 pts) ⚠️ Missable

#### 4.1.6 Prelude; the Wind Shrine and Wing Raptor

- [ ] 🥉 **The Chosen Warriors** — Obtain the crystal shards from the Wind Temple (5 pts)
- [ ] 🥉 **Birdpuncher** — Defeat the wing raptor using only the Attack command. (3 pts) ⚠️ Missable

#### 4.2.1 The Wind Crystal Jobs

- [ ] 🥉 **Get Well Soon** — Checked up on your feathered friend. (2 pts) ⚠️ Missable
- [ ] 🥉 **A Heroic Party Is Formed** — The four companions all agree to set out on a quest to save the world... (1 pts)
- [ ] 🥉 **Reluctant Companion** — Maybe these two really do need my help... (1 pts)

#### 4.3.2 The Torna Canal

- [ ] 🥉 **Thor's Might** — Defeat Karlabos with the Thunder spell. (2 pts) ⚠️ Missable

#### 4.4.2 The battle with Siren

- [ ] 🥈 **Flailure to Account for Amnesia** — Defeat Siren using only Galuf to target Siren, dealing damage only with Flail attacks. (10 pts) ⚠️ Missable

#### 4.6.1 North Mountain

- [ ] 🥉 **Take a Bow** — Make Liquid Flame Kill itself and win its Flame Bow (5 pts) ⚠️ Missable

#### 4.6.2 The battle with Magissa

- [ ] 🥉 **Ice to Meet You** — Defeat Magissa with a Frost Rod before Forza is summoned. (5 pts) ⚠️ Missable

#### 4.7.1 Home sweet home; Castle Tycoon

- [ ] 🥉 **Caring for Magical Creatures** — Enlisted the aid of a Wind Drake (5 pts)
- [ ] 🥉 **This Place Would Have Failed Their Safety Inspection** — Obtained the Ifrit summon spell. (5 pts)
- [ ] 🥉 **Family?** — View a conversation at night on the ramparts of Castle Tycoon. (4 pts) ⚠️ Missable

#### 4.8.3 The golden warrior and the tower of Walse

- [ ] 🥈 **Blue Blaze** — Learn the Iron Claw's blue magic at the gates of Karnark Castle. (10 pts) ⚠️ Missable
- [ ] 🥉 **Stair-based Strength Supplementation** — Climb the Phoenix Tower and choose to fight every door guardian. (5 pts)

#### 4.8.4 The fight with Garula

- [ ] 🥉 **Garula Croaks Twice** — Defeat Garula while it is a Toad (5 pts) ⚠️ Missable
- [ ] 🥉 **Too Late** — Obtain the crystal shards from the Water Temple (5 pts)

#### 4.10.3 Ice to see you, Shiva

- [ ] 🥈 **Icey Mirror Match** — Defeat Shiva and her boys with 3x Front-Row Knights and 1x Back-Row Mage before the events at the top of the Tower of Walse. (10 pts) ⚠️ Missable
- [ ] 🥉 **Diamond Dust** — Obtained the Shiva summon spell. (5 pts) ⚠️ Missable

#### 4.11.2 The battle with Liquid Flame

- [ ] 🥈 **Appropriation Ablaze** — Loot all the treasures of Karnak Castle and escape before time runs out! (10 pts) ⚠️ Missable
- [ ] 🥉 **Explosive Escape** — Obtained some of the blessings of the fire crystal. (5 pts)

#### 4.12.1 Escaping Karnak Castle

- [ ] 🥈 **Ifrit Debuffed** — Kill Ifrit when he is under the influence of three or more status debuffs. (10 pts) ⚠️ Missable

#### 4.14.2 The Library of the Ancients and the battle with Ifrit

- [ ] 🏅 **Grandmaster** — Master every job with every character (50 pts)
- [ ] 🏅 **Testudine Triumph** — Collect all the gil in the Corridor of Gil in the Gil Cave and take one more step... (25 pts) ⚠️ Missable
- [ ] 🏅 **Treasure Master** — Obtain every treasure from the game (25 pts) ⚠️ Missable
- [ ] 🏅 **Warriors of Light** — Beat the game (25 pts)
- [ ] 🥈 **A One and a Two...** — Master the Dancer job with any character. (10 pts)
- [ ] 🥈 **Advanced Hunter** — Kill entries 70-86, 88-104 in the bestiary (10 pts) ⚠️ Missable
- [ ] 🥈 **Animal Lover** — Master the Beastmaster job with any character. (10 pts)
- [ ] 🥈 **Band of Thieves** — Master the Thief job with any character. (10 pts)
- [ ] 🥈 **Basic Hunter** — Kill entries 1-34, 191, and 192 in the bestiary (10 pts) ⚠️ Missable
- [ ] 🥈 **Battle of the Seabeasts** — Defeat Leviathan dealing damage only with Syldra without equipping Coral Rings (10 pts) ⚠️ Missable
- [ ] 🥈 **Beast Slayer** — Kill entries 243-265 in the bestiary (10 pts) ⚠️ Missable
- [ ] 🥈 **Blistering Bombardment** — Master the Cannoneer job with any character. (10 pts)
- [ ] 🥈 **Bonus Hunter** — Kill entries 229-242 and 315-323 in the bestiary (10 pts)
- [ ] 🥈 **Boss Rush** — Clear the Cloister of the Dead (10 pts)
- [ ] 🥈 **Child of the Earth** — Master the Geomancer job with any character. (10 pts)
- [ ] 🥈 **Destroyer** — Master the Black Mage job with any character. (10 pts)
- [ ] 🥈 **Don't Think, Feel!** — Master the Monk job with any character. (10 pts)
- [ ] 🥈 **Dragon Seal** — Defeat Shinryu, the demon dragon (10 pts)
- [ ] 🥈 **Ebony and Ivory** — Master the Red Mage job with any character. (10 pts)
- [ ] 🥈 **Expert Hunter** — Kill entries 87, 135-161, 173-175, 184-190, and 197-203 in the bestiary (10 pts)
- [ ] 🥈 **Giant Slayer** — Kill entries 266-285 in the bestiary (10 pts) ⚠️ Missable
- [ ] 🥈 **Healer** — Master the White Mage job with any character. (10 pts)
- [ ] 🥈 **Hokage** — Master the Ninja job with any character. (10 pts)
- [ ] 🥈 **Kuchiyose no Jutsu** — Master the Summoner job with any character. (10 pts)
- [ ] 🥈 **Machinations of a Madman** — Clear out all the Omegas in the Tomb of Memory - Incubi's Path without leaving the room. (10 pts) ⚠️ Missable
- [ ] 🥈 **Marksman** — Master the Ranger job with any character. (10 pts)
- [ ] 🥈 **Master of Mimicry** — Master the Mime job with any character. (10 pts)
- [ ] 🥈 **Master of Time and Space** — Master the Time Mage job with any character. (10 pts)
- [ ] 🥈 **Maximus Decimus Meridius** — Master the Gladiator job with any character. (10 pts)
- [ ] 🥈 **Mix and Math** — Destroy all four parts of the final boss's final form using L5 Death (10 pts)
- [ ] 🥈 **Monster Scholar** — Master the Blue Mage job with any character. (10 pts)
- [ ] 🥈 **Oh Exdeath, Where is Your Sting?** — An evil foe has fallen and the world is changed forever... (10 pts)
- [ ] 🥈 **Omega Badge** — Defeat Omega, the original killing machine (10 pts)
- [ ] 🥈 **Prediction Machine** — Master the Oracle job with any character. (10 pts)
- [ ] 🥈 **Rurouni** — Master the Samurai job with any character. (10 pts)
- [ ] 🥈 **Skull Buster** — Master the Berserker job with any character. (10 pts)
- [ ] 🥈 **Slowmega Nomega** — Defeat Omega in the Rift while it's under the effects of a Slow debuff. (10 pts) ⚠️ Missable
- [ ] 🥈 **Spellblade Master** — Master the Mystic Knight job with any character. (10 pts)
- [ ] 🥈 **Superboss Slayer** — Kill entries 286-314 in the bestiary (10 pts) ⚠️ Missable
- [ ] 🥈 **The Legendary Twelve** — They are weapons. They are legendary. There are even twelve of them (10 pts)
- [ ] 🥈 **The Music Man** — Master the Bard job with any character. (10 pts)
- [ ] 🥈 **The Traditional Swordsman** — Master the Knight job with any character. (10 pts)
- [ ] 🥈 **The Walking Death** — Master the Necromancer job with any character. (10 pts)
- [ ] 🥈 **Tomb-Raiding Trio** — Enter the Pyramid and claim the first tablet having obtained all the treasures and defeating all robots in one trip without restoring MP. Must be done in a single session without loading mid-pyramid. (10 pts) ⚠️ Missable
- [ ] 🥈 **Treasure Hunter I** — Obtain every treasure from the 1st world (10 pts) ⚠️ Missable
- [ ] 🥈 **Treasure Hunter II** — Obtain every treasure from the 2nd world (10 pts) ⚠️ Missable
- [ ] 🥈 **Treasure Hunter III** — Obtain every treasure from the merged world (10 pts) ⚠️ Missable
- [ ] 🥈 **Treasure Hunter IV** — Obtain every treasure from the bonus dungeon (10 pts)
- [ ] 🥈 **Trial and Error** — Master the Chemist job with any character. (10 pts)
- [ ] 🥈 **Wind Rinder** — Master the Dragoon job with any character. (10 pts)
- [ ] 🥈 **World One Completionist** — Kill entries 35-69 and 193-196 in the bestiary (10 pts) ⚠️ Missable
- [ ] 🥈 **World Three Completionist** — Kill entries 162-172, 178-183, and 204-228 in the bestiary (10 pts) ⚠️ Missable
- [ ] 🥈 **World Two Completionist** — Kill entries 105-134, 176, and 177 in the bestiary (10 pts) ⚠️ Missable
- [ ] 🥉 **Book Burning** — Defeat Byblos with Ifrit (5 pts) ⚠️ Missable
- [ ] 🥉 **Cut That Out** — Defeat Triton, Nereid, and Phobos at the same time without having ever damaged them. (5 pts) ⚠️ Missable
- [ ] 🥉 **Dungeons and Ductwork** — Recover the Tablet from the Island Shrine (5 pts)
- [ ] 🥉 **Flare for the Undramatic** — Defeat Bahamut without him using Mega Flare. [No Zeninage allowed] (5 pts) ⚠️ Missable
- [ ] 🥉 **Fork That** — Obtained the Legendary White and Black Magic spells. (5 pts)
- [ ] 🥉 **Friendship Reborn** — Obtain the Phoenix Summon (5 pts)
- [ ] 🥉 **Gilgamesh Gives His Regards** — Finish off Exdeath in his Castle with the Excalipoor (5 pts) ⚠️ Missable
- [ ] 🥉 **Holy Toads!** — Defeat Halicarnassus while your entire party is a living toad and without dealing damage to her during your characters' turns. (5 pts) ⚠️ Missable
- [ ] 🥉 **I Caught a Friend for You on the Way Here** — Defeat Catoblepas in Galuf's World with !Release and earn its summon. (5 pts) ⚠️ Missable
- [ ] 🥉 **I've Got All the Time in the World** — Deal fatal damage to Shinryu with the HP leak status effect. (5 pts) ⚠️ Missable
- [ ] 🥉 **KaratEgg** — Perform the legendary 'Egg Chop' attack (5 pts)
- [ ] 🥉 **Let's Cut Through This Nonsense** — Destroy all of Necrophobe's Barriers with !Finisher or !Bladeblitz, then complete the fight. (5 pts) ⚠️ Missable
- [ ] 🥉 **Mechas and Mummies** — Recover the Tablet from the Pyramid (5 pts)
- [ ] 🥉 **Mr. Scaredy Book** — Make Apanda scared, then complete the battle. (5 pts) ⚠️ Missable
- [ ] 🥉 **Old Heroes Die Hard** — Destroyed the barrier blocking the way to the castle. (5 pts)
- [ ] 🥉 **Oops I Chose the Wrong Party I** — Kill Minotaur with only Mages and Summoners. No Abilities belonging to the forbidden classes allowed. [Mage = Any class that ends in Mage] (5 pts) ⚠️ Missable
- [ ] 🥉 **Oops I Chose the Wrong Party II** — Kill Omniscient with only non-Mage, non-Summoner classes. No Abilities belonging to the forbidden classes allowed. [Mage = Any class that ends in Mage] (5 pts) ⚠️ Missable
- [ ] 🥉 **Prepare for the Inevitable Victory** — Defeat Calofisteri without releasing the Confirm button for the entire fight. (5 pts) ⚠️ Missable
- [ ] 🥉 **Softened Him Up** — Defeated the Grand Aevis (5 pts)
- [ ] 🥉 **Speedy Swimmer** — Obtain the mysterious power in Sunken Walse Tower and return to the surface in one long breath with 3 minutes or more remaining. No extra oxygen allowed! (5 pts) ⚠️ Missable
- [ ] 🥉 **Thanks, Matey** — Enlist the aid of a lost friend... (5 pts)
- [ ] 🥉 **The Return** — Obtain the crystal shards from the Earth Temple (5 pts)
- [ ] 🥉 **This is for Edward!** — Kill the Antlion without it fleeing (5 pts) ⚠️ Missable
- [ ] 🥉 **Unlocking the Void** — Defeated the Archeodemon (5 pts)
- [ ] 🥉 **Wishmaster** — Obtain the Magic Lamp (5 pts)
- [ ] 🥉 **Yer nuts, mister!** — Go around the world in a Chocobo and receive the Mirage Vest (5 pts)
- [ ] 🥉 **Genji Armor** — Steal the Genji Armor from Gilgamesh and complete the battle. (3 pts) ⚠️ Missable
- [ ] 🥉 **Genji Shield** — Steal the Genji Shield from Gilgamesh and complete the battle. (3 pts) ⚠️ Missable
- [ ] 🥉 **Genji Gloves** — Steal the Genji Gloves from Gilgamesh and complete the battle. (2 pts) ⚠️ Missable
- [ ] 🥉 **Genji Helm** — Steal the Genji Helm from Gilgamesh and complete the battle. (2 pts) ⚠️ Missable

#### 4.14.3 The battle with Byblos

- [ ] 🥉 **Cidstoration** — Obtained the use of the Fire-Powered Ship (5 pts)

#### 4.16.3 Jachol Cave

- [ ] 🥉 **Ramufications of Visiting the Library First** — Obtained the Ramuh summon spell. (5 pts)

#### 4.17.3 The forests of Istory and the battle with Ramuh

- [ ] 🥉 **Toadally Worth The Spin** — Learn the Toad spell from a flower-bound frog. (2 pts)

#### 4.18.2 Crescent Island and the Black Chocobo

- [ ] 🥉 **Heights of Bravery and Courage of Cowardice** — Obtain a maximum power Brave Blade or Chicken Knife (5 pts) ⚠️ Missable
- [ ] 🥉 **I Wanna Be a Shopkeep!** — Try to help out and get gifted a Lamia Harp. (2 pts)

#### 4.20.1 The battle with the Sandworm

- [ ] 🥉 **All About That Bartz** — View all Bartz scenes in his hometown. (5 pts) ⚠️ Missable

#### 4.22.1 The Ancient Ruins and the battle with Adamantoise

- [ ] 🥉 **Whips for Law Abiders** — Recover the Blitz Whip from the Jachol Cave (2 pts) ⚠️ Missable

#### 4.27.1 Galuf to the rescue; the first fight with Gilgamesh

- [ ] 🥉 **Holey Terror** — Kill the Sandworm using only Multi-Target abilities. [Note: Rapid-Fire is not considered by the game to be Mult-Target] (5 pts) ⚠️ Missable

#### 4.27.3 The Big Bridge; the second fight with Gilgamesh

- [ ] 🥉 **Odin Outdone** — Defeat Odin with 40 or more seconds remaining without resorting to Zeninage. (5 pts) ⚠️ Missable
- [ ] 🥉 **Slumberstorm** — Kill Cray Claw while it is asleep. (5 pts) ⚠️ Missable

#### 4.29.1 The sealed castle of Kuza

- [ ] 🥉 **Fly the Crazy Skies** — Gained the use of the ancient airship (5 pts)

#### 4.30.1 The power is yours; saving the planet one Moogle at the time

- [ ] 🥈 **Magic Doesn't Grow on Trees, You Know** — Completely deplete the final boss's tree form of MP before finishing it off. (10 pts)
- [ ] 🥈 **The True Power of the Void** — Defeat Enuo (10 pts)
- [ ] 🥉 **Error: Success** — Uncovered the villain's plan in the Forest of Moore (5 pts)
- [ ] 🥉 **Mr. Clio, Your Psychic Friend** — Pay a visit to the statsman Clio (5 pts)
- [ ] 🥉 **Now You Try It** — Trick Azulmagia into destroying himself via means other than reflect. (5 pts) ⚠️ Missable
- [ ] 🥉 **Two Halves Become One** — Learn how Exdeath may be defeated (5 pts)
- [ ] 🥉 **Unsealed Horrors** — Gained entry to the Arena in the Sealed Temple by proving your worth to the man in the River of Souls (5 pts)
- [ ] 🥉 **Wendigoner** — Kill Wendigo using only Multi-Target abilities that aren't Zeninage. [Note: Rapid-Fire is not considered by the game to be Mult-Target] (5 pts) ⚠️ Missable
- [ ] 🥉 **You're Grounded!** — Kill Twintania with one move. (5 pts) ⚠️ Missable
- [ ] 🥉 **You're Our Only Hope** — Obtain the crystal shards from the Fire Temple (5 pts)

#### 4.31.5 The fight with Dragon Pod

- [ ] 🥉 **Family Secret** — View a conversation at night in the bedroom of Castle Tycoon. (5 pts) ⚠️ Missable

#### 4.32.4 The fight with Atomos

- [ ] 🥉 **One Skill One Kill** — Kill the Adamantoise without selecting more than one non-Defend action. (5 pts) ⚠️ Missable

#### 4.34.1 The fight with Catoblepas

- [ ] 🥈 **Fight Firepower with Fire Focused Fighters** — Defeat the Soulcannon and Launchers with four different fire crystal jobs and having only fire crystal secondary abilities equipped. You may leave the secondary ability empty. (10 pts) ⚠️ Missable
- [ ] 🥉 **This Looks Like a Job for Catoblepas!** — Finish off Carbuncle with Catoblepas (5 pts) ⚠️ Missable

#### 4.35.3 The fight against the Guardians

- [ ] 🥉 **I Like You Just the Way You Are And Also Dead** — Defeat Archeoavis without it changing forms/weaknesses. (5 pts) ⚠️ Missable
- [ ] 🥉 **Memories of Long Ago Fears** — Faris dreams about her childhood. (5 pts) ⚠️ Missable

#### 4.36.1 The fight with the Gil Turtle; get rich or die tryin'

- [ ] 🥈 **The Price of Greed** — Defeat a Gil Turtle in the Gil Cave (10 pts) ⚠️ Missable
- [ ] 🥉 **Stun the Earth** — Kill Titan while he is paralyzed. (5 pts) ⚠️ Missable

#### 4.37.1 Castle Exdeath 1; ascension and the fight with Carbuncle

- [ ] 🥉 **Bomb Diffusers** — Defeat Purobolos without any of them attempting to cast Arise. (5 pts) ⚠️ Missable

#### 4.37.3 The fight with the dark warlock Exdeath

- [ ] 🥉 **Behold the Power of Chemistry!** — Defeat Manticore with a !Mix. (5 pts) ⚠️ Missable
- [ ] 🥉 **Moogle Says** — Exit the Underground Waterway and reach the Moogle Village forest without being attacked [Triggers at reaching the forest itself]. (5 pts) ⚠️ Missable

#### 4.38.1 A second prelude; the fight with Antlion

- [ ] 🥈 **A Whole New World** — Follow Galuf back to his home (10 pts)

#### 4.40.1 The Pyramid of Moore; the Earth tablet

- [ ] 🥉 **Who Mugs the Muggers?** — On the deserted island, steal the Abductor's armor and then kill it. (5 pts) ⚠️ Missable

#### 4.40.2 The fight with Melusine

- [ ] 🥈 **Welcome Weakness** — Defeat Melusine without her using Barrier Change (10 pts) ⚠️ Missable
- [ ] 🥉 **Gilgamesh Dis-armed** — Defeat Gilgamesh on the Big Bridge without letting him buff himself up. (5 pts) ⚠️ Missable

#### 4.43.1 The Island Shrine; the Wind tablet

- [ ] 🥉 **Barrier to Escape** — Galuf and friends make their escape in an unconventional fashion... (5 pts)

#### 4.44.1 Fork Tower; the fight against Minotaur and Omniscient

- [ ] 🥉 **Pub Pals** — Share a drink with Galuf and soothe your worried mind. (3 pts) ⚠️ Missable
- [ ] 🥉 **Workin' Hard for Your Money** — Earn some cash for dancing. (1 pts)

#### 4.46.1 The Great Sea Trench; the Fire tablet

- [ ] 🥉 **Hotchachachaaa** — Obtained the tablet from the Great Sea Trench (5 pts)
- [ ] 🥉 **Jumping Jehosephat!** — Galuf makes a discovery in Kuza (5 pts) ⚠️ Missable

#### 4.47.1 Istory Falls; the Water tablet

- [ ] 🥉 **Splish Splash** — Obtained the tablet from Istory Falls (5 pts)

#### 4.47.2 Istory Falls; the battle with Leviathan

- [ ] 🥉 **No Tinctures for Tiny Arms** — Defeat Tyrannosaur without targetting it with !White, !Mix, or !Items. (5 pts) ⚠️ Missable

#### 4.49.1 Taking the Black Chocobo; the battle with Bahamut

- [ ] 🥉 **Regal Entrance** — Successfully returned from the northern continent after being stranded there. (5 pts)
- [ ] 🥉 **We All Float Down Here** — Defeat Catastrophe without taking any damage. (5 pts) ⚠️ Missable

#### 4.51.7 Interdimensional Rift; the Dimension Castle

- [ ] 🥉 **Well-Wizard Well-Being** — Obtained the Kornago Gourd (3 pts)

#### 4.51.8 Interdimensional Rift; the Last Floor

- [ ] 🥉 **Does This Mean I'm King Now?** — Retrieved a submerged great sword. (2 pts)

#### 4.53.3 The Undeathables; Omega

- [ ] 🥈 **Force Shield** — Defeat Omega Mk.II (10 pts)
- [ ] 🥉 **Sheepish Delight** — Harm a local economy by eating all of the local dish. (3 pts)

#### 4.53.4 The Undeathables; Shinryu

- [ ] 🥉 **Rockstar** — Obtain the Golem summon in Drakenvale (5 pts) ⚠️ Missable

#### 4.54.3 The Sealed Temple; The Lethe Court

- [ ] 🥉 **Lenna Saves the Day** — Defeat Dragon Pod without it being damaged by anyone besides Lenna. (Note: Continuous sources of damage such as poison are treated as non-Lenna sources of damage) (5 pts) ⚠️ Missable

#### 4.55.1 The Dark Arts

- [ ] 🥉 **Dark Lord** — Obtain every dark art (5 pts)

#### 4.56.1 The Undeathables; Omega Mk. II

- [ ] 🥉 **Sacrificial Heart** — Save Krile's wind drake. (5 pts)

#### 4.56.2 The Undeathables; Neo Shinryu

- [ ] 🥈 **Neo Demon Dragon** — Defeat Neo Shinryu (10 pts)
- [ ] 🥉 **Show Him Who's Boss** — Defeat Gilgamesh on the boat in one move after Enkidu is summoned. (5 pts) ⚠️ Missable

#### 4.57.1 The Cloister of the Dead

- [ ] 🥉 **Let Me Show You How Much You Suck** — Defeat Atomos within two moves. ['Move' here means anything affecting Atomos] (5 pts) ⚠️ Missable
- [ ] 🥉 **It's a Sehkmet to Everybody** — Defeat Sehkmet (3 pts)

#### 6.10 White Mage WHITEM-LINK

- [ ] 🥉 **Holy Avenger** — Obtain every white magic spell (5 pts)

#### 6.11 Black Mage BLACKM-LINK

- [ ] 🥉 **Destruction Master** — Obtain every black magic spell (5 pts)

#### 6.12 Time Mage TIMEM-LINK

- [ ] 🥉 **Immortal** — Obtain every time magic spell (5 pts)

#### 6.14 Blue Mage BLUEM-LINK

- [ ] 🥉 **Mega Man** — Obtain every blue magic spell (5 pts)

#### 7.3 !Spellblade SPELLBLADE-LINK

- [ ] 🥉 **Avan De Ziniur III** — Obtain every spellblade (5 pts) 🔓 Ongoing

#### 7.7 !Summon SUMMON-LINK

- [ ] 🥉 **Extra Sensory Perception** — Obtain every summon (5 pts) ⚠️ Missable

#### 7.14 !Sing SING-LINK

- [ ] 🥉 **Pop Idol** — Obtain every song (5 pts) ⚠️ Missable

#### 8.8 Defense and Magic Defense

- [ ] 🥉 **Decontaminated Defense Destroyer** — Defeat Guardian with everyone alive and unpetrified. (5 pts) ⚠️ Missable
